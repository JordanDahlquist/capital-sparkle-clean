...
const SLUG = "house-washing-saratoga-springs-ny";

export const Route = createFileRoute("/house-washing-saratoga-springs-ny")({
  head: () => {
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: c.service, item: `${SITE}/house-washing` },
