...
const SLUG = "concrete-cleaning-saratoga-springs-ny";

export const Route = createFileRoute("/concrete-cleaning-saratoga-springs-ny")({
  head: () => {
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: c.service, item: `${SITE}/concrete-cleaning-sealing` },
